...
const map = {
  pendiente_anticipo: { label: 'Pendiente anticipo', cls: 'bg-yellow-100 text-yellow-800' },
...
const cfg = map[props.estado] ?? { label: props.estado, cls: 'bg-gray-100 text-gray-600' }
</script>
