...
export const pagar              = (usuarioId, fechaInicio, observaciones = null) =>
  api.post('/nomina/pagos', { usuario_id: usuarioId, fecha_inicio: fechaInicio, observaciones })
...
// Incapacidad médica: misma tabla que la falta, pero solo descuenta el
// auxilio de transporte por día en vez del día completo.
export const crearIncapacidad  = (payload) => api.post('/nomina/ausencias', { ...payload, tipo: 'incapacidad' })
