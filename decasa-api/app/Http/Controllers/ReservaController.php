    ...
    public function salida(Request $request)
    {
        ...
        $inv = DB::transaction(function () use ($data, $fabrica, $request) {
            ...
            $asignadoConfigs = DB::table('inventario_variante_configs as ivc')
                ...
                ->where('ivc.tienda_id', $fabrica->id)
            ...
            if ($nuevoDisponible < $maxAsignado) {
                ...
                abort(422, "Hay {$maxAsignado} unidad(es) asignadas a variantes. Solo puedes quitar hasta {$puedeQuitar}.");
            }
